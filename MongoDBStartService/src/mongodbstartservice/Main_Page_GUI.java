...
public class Main_Page_GUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Main_Page_GUI
     */
    void message_box(Object a) {
    ...
    private void initComponents() {
        ...
        setTitle("Torn MongoDB Starter Version 2.0");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("Choose path for mongod.exe");
        ...
        jLabel5.setText("(Optional - Default is 27017)");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setText("Choose path for database folder");
        ...
        jButton3.setText("Start Service for MongoDB");
        ...
        jLabel8.setText("<html>\nBeware !! Mongod.exe & DB should on same drive (C: , D:) <br/>\nNot support cross drive\n</html>");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JFileChooser get_db_path = new JFileChooser(System.getProperty("user.home"));
